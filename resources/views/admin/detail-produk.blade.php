...
<div class="container grid px-6 mx-auto" style="width:1000px">
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
              ...
              <label class="block text-sm mt-4">
                ...
                <input type="text" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray" name="product_description" disabled value="{{ $data->product_description }}">
              </label>
