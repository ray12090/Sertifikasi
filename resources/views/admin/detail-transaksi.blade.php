        ...
        <div class="" style="width:900px">
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <label class="block text-sm">
                    ...
                    <input type="text" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray" name="user_id" disabled value="{{ $data->user_name }}">
                </label>

                <label class="block text-sm">
                    <span class="text-gray-700 dark:text-gray-400 font-bold">Duration Rent</span>
                    <div class="flex">
                        <input type="text" class="block w-1/3 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray" name="user_id" disabled value="{{ $data->borrow_date }}">
                        <div class="w-1/3">
                            <p class="text-center mt-3">to</p>
                        </div>
                        <input type="text" class="block w-1/3 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray" name="user_id" disabled value="{{ $data->return_date }}">
                    </div>
                </label>
                ...
                <div class="flex">
                    ...
                    <input type="number" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray" name="total_price" disabled value="{{ $data->price }}">
                </label>
                    </div>
                </div>
                <label class="block text-sm mt-4">
                    <span class="text-gray-700 dark:text-gray-400 font-bold">Penalty</span>
                    <input type="number" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple text-red-400 dark:focus:shadow-outline-gray" name="total_price" disabled value="{{ $data->penalty }}">
                </label>
                <label class="block text-sm mt-4">
