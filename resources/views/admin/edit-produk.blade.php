                    ...
                    <form action="{{ route('data-produk.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                name="product_name" value="{{ old('product_name', $data->product_name) }}"
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                value="{{ old('product_description', $data->product_description) }}"
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="file"
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input @error('photo') is-invalid @enderror"
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                name="price" value="{{ old('price', $data->price) }}" placeholder="Masukkan Harga Produk">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                name="category1" value="{{ old('category1', $data->category1) }}"
                                placeholder="Masukkan Kategori Produk 1">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                name="category2" value="{{ old('category2', $data->category2) }}"
                                placeholder="Masukkan Kategori Produk 2">
