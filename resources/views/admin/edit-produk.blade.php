                ...
                <form action="{{ route('data-product.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                name="product_name" value="{{ old('product_name',$data->product_name) }}" placeholder="Input Product Name">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                name="product_description" value="{{ old('product_description',$data->product_description) }}"
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                name="price" value="{{ old('price',$data->price) }}" placeholder="Input Price">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                name="category1" value="{{ old('category1',$data->category1) }}" placeholder="Input Category 1">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                name="category2" value="{{ old('category2',$data->category2) }}" placeholder="Input Category 2">
