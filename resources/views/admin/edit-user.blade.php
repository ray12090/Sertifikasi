                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <form action="{{ route('data-user.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input @error('name') is-invalid @enderror"
                                name="name" value="{{ old('title', $data->name) }}" placeholder="Masukkan Nama Lengkap">
                        ...
                        <label class="block text-sm mt-4">
                            ...
                            <input type="email"
                                ...
                                name="email" value="{{ old('title', $data->email) }}" placeholder="Masukkan Email">
                            @error('email')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
