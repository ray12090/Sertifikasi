                    ...
                    <form action="{{ route('data-produk.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                name="product_name" value="{{ old('product_name') }}" placeholder="Masukkan Nama Produk">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                name="category1" value="{{ old('category1') }}" placeholder="Masukkan Kategori Produk 1">
                        ...
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                ...
                                name="category2" value="{{ old('category2') }}" placeholder="Masukkan Kategori Produk 2">
