<x-app-layout>
    ...
    <form id="checkoutModal" method="POST" style="display:none;">
        @csrf
        @method('post')
    </form>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    @forelse(session('cart', []) as $id => $details)
                        ...
                        @endphp
                        <form id="cartForm" action="{{ route('update.cart.item', $id) }}" method="POST">
                            @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <input type="number" name="quantity" value="{{ $details['quantity'] }}"
                                                class="p-1 pl-2 w-10 quantity-input" data-id="{{ $id }}"
                                                min="1" max="2">
                                        </td>
                                        <td
                                            class="border-b dark:border-slate-600 font-bold p-4 pl-8 text-slate-800 dark:text-slate-600 text-center">
                                            ...
                                            <input type="date" name="borrow_date"
                                                ...
                                                class="p-1 pl-2 w-50 date-input" data-id="{{ $id }}"
                                                min="{{ today()->toDateString() }}"><br>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6" class="font-bold p-4 pl-8 text-slate-800 dark:text-slate-800 text-right">
                                <strong>Total:
                        ...
                        <tr>
                            <td colspan="7" class="text-right">
                                ...
                                {{-- <button type="submit" name="updateCart"
                                    ...
                                    onclick="event.preventDefault(); showCheckoutModal();">
                                    Checkout
                                </button> --}}
                                <button type="submit" name="updateCart"
                                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
    ...
    <script>
        ...
        function confirmCheckout() {
            ...
            document.getElementById('cartForm').action = "{{ route('checkout') }}";
        ...
        //     const borrowDateInput = document.querySelector(`input[name="borrow_date"][data-id="${id}"]`);
        //     const returnDateInput = document.querySelector(`input[name="return_date"][data-id="${id}"]`);
        ...
        // // Add event listeners for quantity and date inputs
